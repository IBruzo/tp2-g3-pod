...
public class PopularInfractionsMapper implements Mapper<String, Q2Infraction, String, Pair<String, Integer>>, HazelcastInstanceAware {
    ...
    @Override
    public void map(String key, Q2Infraction value, Context<String, Pair<String, Integer>> context) {
